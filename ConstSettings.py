...
def define():
    ...
    CONST.DINGTALK_ROBOT = "https://oapi.dingtalk.com/robot/send?access_token=" \
                           "2f72ef86eceb2b369ef31dc3549d5441cf60020bdeaf9b57cf3d7163438bd038"
    #客户名称+客户通道授权码
    CONST. TONGDAO_CODE = {'郑州金麦':'20170728zzjm','合肥超港':'z9cggs20171124','淮安金鸡':'z9hajj20180418','长沙多喜来':'z9csdxl20171127','巩义花儿':'z9gyhe20180504','宁德艾宁檬':'z9ndanm20171222','南宁一品轩':'z9nnypx20180116'}
    #信道
